...
const ModalExample = ({ isModalOpen }: IModalExample) => {
  return (
    <div
      id="defaultModal"
      tabIndex={-1}
      ...
      className={`${
        isModalOpen ? "" : "hidden"
      } fixed top-0 left-0 right-0 z-50 h-full w-full overflow-x-hidden overflow-y-auto md:inset-0 h-modal`}
    >
      <div className="w-full h-full flex justify-center items-center relative">
        <div className="overlay w-full h-full absolute top-0 left-0 bg-gray-700 opacity-50"></div>
